...
/// <summary>Custom editor script class for excel file setting.</summary>
...
public class ExcelMachineEditor : BaseMachineEditor {
	...
	/// <summary>Import the specified excel file and prepare to set type of each cell.</summary>
	...
	/// <summary>Generate AssetPostprocessor editor script file.</summary>
