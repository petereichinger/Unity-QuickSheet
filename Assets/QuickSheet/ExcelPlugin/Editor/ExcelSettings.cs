...
/// <summary>A class to manage excel setting.</summary>
public class ExcelSettings : ScriptableObject {
	...
	/// <summary>A property which specifies or retrieves generated runtime class path.</summary>
	...
	/// <summary>A property which specifies or retrieves generated editor class path.</summary>
	...
	/// <summary>Create new account setting asset file if there is already one then select it.</summary>
	[MenuItem("Assets/Create/QuickSheet/Setting/Excel Setting")]
	public static void CreateExcelSetting() {
		ExcelSettings.Create();
	}

	/// <summary>Select currently exist account setting asset file.</summary>
	...
	/// <summary>Checks ExcelSetting.asset file exist at the specified path(AssetPath+AssetFileName).</summary>
	...
	/// <summary>A property for singleton.</summary>
	public static ExcelSettings Instance {
		get {
			if (s_Instance == null) {
				// A tricky way to assess non-static member in the static method.
				ExcelSettings temp = ScriptableObject.CreateInstance<ExcelSettings>();
