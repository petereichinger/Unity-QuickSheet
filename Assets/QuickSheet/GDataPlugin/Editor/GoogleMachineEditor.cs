...
/// <summary>An editor script class of GoogleMachine class.</summary>
[CustomEditor(typeof(GoogleMachine))]
public class GoogleMachineEditor : BaseMachineEditor {
	private PropertyField[] databaseFields;
	...
	/// <summary>Draw custom UI.</summary>
	...
	/// <summary>A delegate called on each of a cell query.</summary>
	private delegate void OnEachCell(CellEntry cell);
	...
	/// <summary>Connect to the google spreadsheet and retrieves its header columns.</summary>
