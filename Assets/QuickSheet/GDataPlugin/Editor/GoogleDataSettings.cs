...
/// <summary>A class to manage google account setting.</summary>
public class GoogleDataSettings : ScriptableObject {
	...
	/// <summary>Checks GoogleDataSetting.asset file exist at the specified path(AssetPath+AssetFileName).</summary>
