...
namespace GDataDB.Linq.Impl {
	...
	/// <summary>From http://blogs.msdn.com/mattwar/archive/2007/08/01/linq-building-an-iqueryable-provider-part-iii.aspx</summary>
	public static class Evaluator {

		/// <summary> Performs evaluation & replacement of independent sub-trees </summary> <param
		...
		/// <summary> Evaluates & replaces sub-trees when first candidate is reached (top-down) </summary>
