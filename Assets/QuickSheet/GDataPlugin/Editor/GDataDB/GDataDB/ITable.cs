...
namespace GDataDB {
	...
	/// <summary>Worksheet in a spreadsheet document</summary>
	/// <typeparam name="T"></typeparam>
	public interface ITable<T> {

		/// <summary>Deletes this worksheet</summary>
		void Delete();
		...
		/// <summary>Gets a row by index number</summary>
		/// <param name="rowNumber"></param>
		/// <returns></returns>
		IRow<T> Get(int rowNumber);

		/// <summary>Gets all stored rows in this worksheet</summary>
		/// <returns></returns>
		IList<IRow<T>> FindAll();

		/// <summary>Gets all stored rows in this worksheet, paged</summary>
		/// <param name="start"></param>
		/// <param name="count"></param>
		/// <returns></returns>
		IList<IRow<T>> FindAll(int start, int count);

		/// <summary>Free text row search</summary>
